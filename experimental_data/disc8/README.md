...
Multi-camera reconstruction data for a cable-driven continuum manipulator under combined cable actuation and an external hanging-weight force applied at **disk 8**.
...
- **`disc8`** = external force attached at the **8th disk from the base**

### Trials included

| Folder | Drive length (`lact`) | Weight (g) | Force disk |
|--------|----------------------|------------|------------|
| `lact3-weight10-disc8` | 3 | 10 | 8 |
| `lact3-weight20-disc8` | 3 | 20 | 8 |
| `lact3-weight30-disc8` | 3 | 30 | 8 |
| `lact3-weight40-disc8` | 3 | 40 | 8 |
| `lact3-weight50-disc8` | 3 | 50 | 8 |
| `lact4-weight10-disc8` | 4 | 10 | 8 |
| `lact4-weight20-disc8` | 4 | 20 | 8 |
| `lact4-weight30-disc8` | 4 | 30 | 8 |
| `lact4-weight40-disc8` | 4 | 40 | 8 |
| `lact4-weight50-disc8` | 4 | 50 | 8 |
